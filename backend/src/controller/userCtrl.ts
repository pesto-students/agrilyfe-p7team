...
const handleRefreshToken = asyncHandler(async (req: any, res: any) => {
...
const updatedUser = asyncHandler(async (req: any, res: any) => {
  const { _id } = req.user;
...
const saveAddress = asyncHandler(async (req: any, res: any, next: any) => {
  const { _id } = req.user;
  validateMongoDbId(_id);
...
const getaUser = asyncHandler(async (req: any, res: any) => {
  const { id } = req.params;
...
const deleteaUser = asyncHandler(async (req: any, res: any) => {
  const { id } = req.params;
  validateMongoDbId(id);
...
const blockUser = asyncHandler(async (req: any, res: any) => {
  const { id } = req.params;
  validateMongoDbId(id);
...
const unblockUser = asyncHandler(async (req: any, res: any) => {
  const { id } = req.params;
  validateMongoDbId(id);
...
const userCart = asyncHandler(async (req: any, res: any) => {
  const { cart } = req.body;
  const { _id } = req.user;
  validateMongoDbId(_id);
  try {
...
const getUserCart = asyncHandler(async (req: any, res: any) => {
  const { _id } = req.user;
  validateMongoDbId(_id);
  try {
...
const emptyCart = asyncHandler(async (req: any, res: any) => {
  const { _id } = req.user;
  validateMongoDbId(_id);
  try {
...
const applyCoupon = asyncHandler(async (req: any, res: any) => {
...
const getOrderByUserId = asyncHandler(async (req: any, res: any) => {
  const { id } = req.params;
  validateMongoDbId(id);
  try {
