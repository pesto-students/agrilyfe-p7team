...
router.post("/create-user", upload.single("file"), async (req: any, res: any, next: any) => {
  try {
    ...
    // const activationUrl = `https://tutorial-cefl.vercel.app/activation/${activationToken}`;
